      ...
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              Hi, my name is Deni Sumarno and I am a{" "}
              <span className="font-bold">{" Humble "}</span>,
              <span className="font-bold">{" self-motivated "}</span>, and
              <span className="font-bold">{" Continue Learning "}</span> Devops
              Engineer based in Jakarta.
            </p>
            <br />
            <p>
              I graduated from Budi Luhur University, Jakarta in 2023 Computer
